...
class ElectronicCategoryBasedProvider extends ChangeNotifier {
  ...
  // Translation cache - shared across all category providers for better performance
  ...
  ElectronicCategoryBasedProvider() {
    _initializeProvider();
  }
