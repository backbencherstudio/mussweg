          ...
          Stack(
            children: [
              SizedBox(
                ...
                child:
                    userVM?.profile.coverPhotoUrl != null
                        ? Image.network(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(width: 4),
                        Text(
                          userVM?.profile.rating.toString() ?? '',
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(width: 4),
                        Text(
                          userVM?.profile.address == null ||
                                  userVM?.profile.city == null
                              ? 'unknown'
                              : '${userVM?.profile.address}, ${userVM?.profile.city}',
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return SellerProfileRefresh(
                              title:
                                  userVM?.reviews.data[index].reviewerName ??
                                  '',
                              time:
                                  userVM?.reviews.data[index].createdAgo ?? '',
                              avatarUrl:
                                  userVM?.reviews.data[index].reviewerAvatar ??
                                  '',
                              message:
                                  userVM?.reviews.data[index].comment ?? '',
                              starCount:
                                  userVM?.reviews.data[index].rating ?? 0,
                            );
                          },
                        ),
                      ],
