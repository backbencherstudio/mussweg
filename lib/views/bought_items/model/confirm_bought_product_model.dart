class ConfirmBoughtProductModel {
  bool? success;
  String? message;
  List<Data>? data;
  Pagination? pagination;

  ConfirmBoughtProductModel({this.success, this.message, this.data, this.pagination});

  ConfirmBoughtProductModel.fromJson(Map<String, dynamic> json) {
