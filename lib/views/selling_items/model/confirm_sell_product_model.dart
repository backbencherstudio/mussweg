class ConfirmSellProductModel {
  bool? success;
  String? message;
  List<Data>? data;
  Pagination? pagination;

  ConfirmSellProductModel({
    this.success,
    this.message,
    this.data,
    this.pagination,
  ...
  ConfirmSellProductModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    orderPartner =
        json['order_partner'] != null
            ? OrderPartner.fromJson(json['order_partner'])
            : null;
    if (json['items'] != null) {
      items = <Items>[];
    ...
    : total =
      ...
      perPage =
          json['perPage'] is String
              ? int.tryParse(json['perPage']) ?? 0
              : json['perPage'] ?? 0,
      totalPages =
          json['totalPages'] is String
