class CancelSellProductModel{
  bool? success;
  String? message;
  List<Data>? data;
  Pagination? pagination;

  CancelSellProductModel({this.success, this.message, this.data, this.pagination});

  CancelSellProductModel.fromJson(Map<String, dynamic> json) {
